...
export default function WhyUsSection() {
    return (
        <section id="why-us">
            ...
            <div className="py-[40px] lg:py-9 px-[20px] lg:px-32 overflow-hidden">
                <div className="grid md:grid-cols-2 gap-5 md:gap-26 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-white font-poppins font-light text-[14px] sm:text-[16px] leading-[178%] sm:leading-[178%]">
                            Nous prêtons une attention particulière à la comprehension de votre besoin pour vous mettre à disposition des experts soigneusement sélectionnés par
                            rapport à leurs domaines de compétence afin de vous mettre en place une solution sur-mesure pour votre organisation. Avec notre équipe d’experts, nous
                            fournissons des solutions digitales performantes et résilientes. Nous aidons les entreprises à atteindre leurs objectifs de manière innovante et
                            efficace.
                        </p>
                    </div>
                </div>
