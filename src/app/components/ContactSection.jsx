...
export default function ContactSection() {
    return (
        <section className="py-16 md:py-20 px-4 md:px-32 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-[15px] md:gap-0 items-center pb-[60px]">
                {/* Column 1 */}
                <div>
            ...
            <div className="border border-[#ED7D4A] p-[10px] rounded">
                <div className=" grid grid-cols-1 md:grid-cols-12 gap-[114px]">
                    {/* Contact Information */}
                    ...
                    {/* Contact Form */}
                    <div className="col-span-7 my-[20px] mx-[15px]">
