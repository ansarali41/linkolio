...
export default function ClientsSection() {
    ...
    return (
        <section className="py-[40px] lg:py-20">
                            ...
                            <div className="relative">
                                ...
                                <div className="relative">
                                    <div className="bg-[#ED7D4A] rounded-[15px] lg:rounded-[20px] py-[29px] lg:py-[101px] pl-[5px]  lg:pl-[56px] w-[90px] h-[122px] lg:w-[285px] lg:h-[345px] inline-block mb-[60px]">
                                        ...
                                        <p className="text-[#313E47] font-poppins font-medium text-[6px] lg:text-[10px] leading-[15px] lg:leading-[25px]">{client.position}</p>
                                        {/* line */}
                                ...
                                <div className="absolute left-42 lg:left-115 top-15 lg:top-1/2 -translate-y-1/2">
                                    <div className="relative ">
                                        <div className="flex items-center justify-center lg:w-[300px]">
                                            <p className="text-white font-poppins font-medium text-[10px] lg:text-[16px] leading-[15px] lg:leading-[25px]">{client.testimonial}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
